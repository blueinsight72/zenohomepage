  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "절감은 얼마나 되나요?", "acceptedAnswer": { "@type": "Answer", "text": "기업의 품목 구성과 구매 방식에 따라 다릅니다. 제노는 절감액이나 절감률을 미리 약속하지 않습니다. 도입 전 구매·지출 분석에서 귀사의 절감 여지를 데이터로 먼저 확인해 드리고, 절감은 도입 후 청구 반영까지 확인한 실측치로 검증합니다. 경영진에게 보고하는 숫자는 실현된 절감(Realized Saving)입니다." } }
      ]
    }
  ]
}
