  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "영업 상담 없이 제품을 먼저 볼 수 있나요?", "acceptedAnswer": { "@type": "Answer", "text": "가능합니다. 홈페이지에 구매 요청 한 건이 정산까지 가는 과정을 담은 2분 30초 제품 투어를 신청 없이 공개하고 있습니다. 구매 시스템 도입 체크리스트, 간접구매 규정 템플릿, 지출 진단 가이드 세 가지 자료도 이메일만 남기시면 받아보실 수 있습니다." } },
